...
import com.taotao.service.log.LogApiService;
import com.taotao.web.util.WebUtils;
...
//		}
		...
		upmsLog.setBasePath(WebUtils.getContextPath(request));
		upmsLog.setIp(WebUtils.getRemoteIp(request));
