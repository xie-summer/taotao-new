...
public class CodeGenerator {
    ...
    private static final String BASE_PACKAGE_PATH = "/com/taotao/whats/";//项目基础包路径
    private static final String PACKAGE_PATH_SERVICE = BASE_PACKAGE_PATH + "/service/role/";//生成的Service存放路径
    private static final String PACKAGE_PATH_SERVICE_IMPL = BASE_PACKAGE_PATH + "/service/role/impl/";//生成的Service实现存放路径
    private static final String PACKAGE_PATH_CONTROLLER = BASE_PACKAGE_PATH + "/web/controller/role/";//生成的Controller实现存放路径
    ...
    public static void main(String[] args) {
        genCode("t_role");
//     String  tableName = "t_role".substring(2);
